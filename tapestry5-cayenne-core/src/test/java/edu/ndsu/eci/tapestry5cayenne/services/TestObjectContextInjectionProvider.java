...
import edu.ndsu.eci.tapestry5cayenne.internal.ObjectContextWrapper;
import edu.ndsu.eci.tapestry5cayenne.services.ObjectContextInjectionProvider;
...
//
//    EasyMock.expect(builder.build(EasyMock.isA(ObjectContextWrapper.class), EasyMock.eq("currentContext"),
...
//
//    EasyMock.expect(builder.build(EasyMock.isA(ObjectContextWrapper.class), EasyMock.eq("currentContext"),
//        EasyMock.eq(ObjectContext.class))).andReturn(mock);
//
//    replay();
//
//    assertTrue(p.provideInjection("context", ObjectContext.class, null, transformation, null));
...
//
//    EasyMock.expect(builder.build(EasyMock.isA(ObjectContextWrapper.class), EasyMock.eq("newContext"),
//        EasyMock.eq(ObjectContext.class))).andReturn(mock);
//
//    replay();
//
...
//
//    EasyMock.expect(builder.build(EasyMock.isA(ObjectContextWrapper.class), EasyMock.eq("childContext"),
//        EasyMock.eq(ObjectContext.class))).andReturn(mdc);
//
//    replay();
//
//    assertTrue(p.provideInjection("context", ObjectContext.class, null, transformation, null));
...
//    } else {
//      EasyMock.expect(tf.getAnnotation(OCType.class)).andReturn(new OCType() {
